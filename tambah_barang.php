        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Programmer Pemula</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form action="proses_tambah_barang.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                    <div class="form-grup">
                        <label for="nama">Kode Barang</label>
                        <input type="text" name="kode" id="kode" class="form-control" placeholder="Kode Barang" required>
                    </div>
                    <div class="form-grup">
